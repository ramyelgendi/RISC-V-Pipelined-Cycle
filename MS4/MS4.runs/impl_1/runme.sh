...
HD_PWD='C:/Users/Sabouzeid0/Downloads/ms4_ALMOSTFINAL1/ms4_ALMOSTFINAL1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCV.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RISCV.tcl -notrace
